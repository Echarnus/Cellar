...
enum TestHome {
    ...
    static let root: URL = {
        ...
        let base = (environment["CELLAR_TEST_ROOT"].flatMap { $0.isEmpty ? nil : $0 })
    ...
    static func installStubRunner(id: String = RunnerCatalog.defaultID) -> RunnerInstall? {
        ...
        guard Paths.appSupport.path.hasPrefix(root.path) else { return RunnerManager.find(id: spec.id) }
