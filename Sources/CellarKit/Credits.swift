...
public enum Credits {
    ...
    public static let all: [Credit] = [
        ...
        Credit(name: "CodeWeavers · CrossOver",
               role: "The macOS patches (Mac driver work, msync) that make Wine fast on a Mac. Cellar uses only the public LGPL sources, never CrossOver itself.",
               license: "LGPL-2.1+",
               url: "https://www.codeweavers.com/crossover",
               sourceURL: "https://github.com/CodeWeavers/wine"),
        Credit(name: "WineForge",
               role: "The default runner: Wine 11 with the CrossOver patches, prebuilt for macOS.",
               license: "LGPL-2.1+",
